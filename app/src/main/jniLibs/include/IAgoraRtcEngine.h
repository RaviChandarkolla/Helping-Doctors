...
/** Video displayof the VideoCanvas class.
*/
struct VideoCanvas
{
...
public:
  ...
  virtual void onRemoteVideoStats(const RemoteVideoStats& stats) {
    ...
    */
    ...
    This callback function is triggered after the first frame of the remote video is received and successfully decoded. The application can configure the user viewin this callback function.
...
public:
    ...
    /** Sets the local video view.
     ...
     This method configures the video displayon the local machine.

     The application calls this method to bind each video window (view) of the local video streams and configures the video display settings. Call this method after initialization to configure the local video displaybefore entering a channel. After leaving the channel, the binding is still valid, which means that the window will still display. To unbind the view, set the view value to NULL when calling setupLocalVideo.
    ...
    */
	...
	/** Sets the audio parameters and application scenarios.
     ...
     - In the communication and live-broadcast modes, the bitrate may be different from yourdue to network self-adaptation.
  ...
  virtual int updateScreenCaptureRegion(const Rect *rect) = 0;
    ...
    */
    ...
    /** @deprecated
     ...
     Removes the picture-in-picture layoutcreated by \ref IRtcEngine::setVideoCompositingLayout "setVideoCompositingLayout".
    ...
    /** Adds a watermark to the local video stream.
     ...
     - The source file of the watermark image must be in the PNG file format. If the width and height of the PNG file differ from yourin this method, the PNG file will be cropped to conform to your settings.
