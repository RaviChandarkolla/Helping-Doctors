...
enum WARN_CODE_TYPE
{
  ...
  */
    ...
    */
    ...
    /** 1053: Audio Device Module: The underlying audiohave changed.
    */
...
enum ERROR_CODE_TYPE
{
  ...
  */
    ...
    */
     ...
     */
    ERR_ABORTED = 20,
    /** 21: In Windows, specific firewallcan cause the SDK to fail to initialize and crash.
     */
    ...
    /** 120: Decryption failed. The user may have used a different encryption password to join the channel. Please check youror try rejoining the channel.
     */
